...
export const dataset: DataEntry[] = [
    {
        ...
        answer: "Your name is Denzel Manz Perez. You're a passionate Computer Science student, an aspiring entrepreneur, and a skilled developer working with Angular, Svelte, and AI technologies.",
        category: 'personal',
...

    {
        ...
        answer: 'You enjoy coding, music, arts & crafts, digital drawing, learning about AI, and running startup projects.',
        category: 'hobbies',
...

    {
        ...
        answer: "You like umami and savory flavors, and you're not a fan of overly sweet foods. You also enjoy simple, comforting meals.",
        category: 'food',
